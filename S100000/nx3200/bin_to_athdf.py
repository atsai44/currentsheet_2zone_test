...
for bin_file in bin_files:
    ...
    athdf_fname = os.path.join(h5py_dir, base_name + ".athdf")
    xdmf_fname  = os.path.join(h5py_dir, base_name + ".athdf.xdmf")
...
print("Conversion complete. .athdf files are in the h5py/ folder.")